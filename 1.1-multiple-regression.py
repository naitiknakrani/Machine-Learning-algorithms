...
### Change regression variable from FUELCONSUMPTION_COMB TO 
### FUEL_CONSUMPTION_CUTY AND FUEL_CONSUMPTION_HIWAAY

cdf = df[['ENGINESIZE','CYLINDERS','FUELCONSUMPTION_CITY','FUELCONSUMPTION_HWY','CO2EMISSIONS']] # select few samples
